...
const _keyClientId = 'bearimetric_device_client_id';
const _keyClientSecret = 'bearimetric_device_client_secret';
const _keyDomain = 'bearimetric_device_domain';
const _keyAudience = 'bearimetric_device_audience';
